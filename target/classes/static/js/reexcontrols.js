...
function showFormContatoCompraImovel(){
			var y = document.getElementById("form-contato-imovel");
			if (y.style.display == "none"){
				y.style.display = "block";
				window.location.href = "#form-contato-imovel";
			}else{
				y.style.display = "none";
			}
		}
...
function showFormContatoCorretorDetalhe(){
			var y = document.getElementById("form-corretor-detalhe");
			if (y.style.display == "none"){
				y.style.display = "block";
				window.location.href = "#form-corretor-detalhe";
			}else{
				y.style.display = "none";
			}
		}
